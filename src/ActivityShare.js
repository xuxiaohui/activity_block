...
const ACTIVITYBLOCK = ParamConfig['ACTIVITYBLOCK'];

export default [
    //体检
    {key:'physical_examination',
        value:ACTIVITYBLOCK['physical_examination'],
        desc:'商品',
    ...
    //实物商品
    {key:'actual_good',
        value:ACTIVITYBLOCK['actual_good'],
        desc:'商品',
        shareLogo:`/assets/images/share_logo.png`,
        shareUrl:`${UrlPath['ECSHOP_DETAIL']}?ativityId={0}`
    },
    //公开课
    {key:'public_class',
        value:ACTIVITYBLOCK['public_class'],
        desc:'公开课',
        shareLogo:`/assets/images/share_logo.png`,
    ...
    //悦儿早报
    {key:'yue_morning',
        value:ACTIVITYBLOCK['yue_morning'],
        desc:'悦儿早报',
    ...
    //福利汇
    {key:'welfare',
        value:ACTIVITYBLOCK['welfare'],
        desc:'健康活动',
        shareUrl:`${UrlPath['WELFARE_DETAIL']}?id={0}`
    },
    //月子中心
    {key:'yue_center',
        value:ACTIVITYBLOCK['yue_center'],
        desc:'月子中心',
